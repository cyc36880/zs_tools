#include "../include/cc_array_sort.h"

/*****************************************************************************
 * Quick sort (https://en.wikipedia.org/wiki/Quicksort)
 ****************************************************************************/
static size_t cc_array_divide(cc_array_t *self, cc_cmp_fn_t cmp,
...
static void cc_array_sort_quick_recur(cc_array_t *self, cc_cmp_fn_t cmp,
		size_t start, size_t end)
{
	size_t m;
...
int cc_array_sort_quick(cc_array_t *self, cc_cmp_fn_t cmp)
{
	if (cmp == NULL)
		return 1;
 ...
 ****************************************************************************/
int cc_array_sort_bubble(cc_array_t *self, cc_cmp_fn_t cmp)
{
	size_t i, j, k;
